...
class DashscopeTestCase(unittest.TestCase):
    ...
    def test_conversation(self):
        self.api.as_chat(ModelEnum.BAILIAN, "你是一位专业翻译官，负责将接下来用户提供的学校名称翻译，并精准匹配到其官方的中文校名。用户输入的所有整体就是一个待翻译校名。你也只回答翻译后的校名")
        r = self.api.chat('Chiway Repton High School Xiamen') # 厦门华锐莱普顿学校
        print(r)
